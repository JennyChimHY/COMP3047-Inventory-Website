            ...
            <form>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input v-model="inventory.amount" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="amount">
                    </div>

                    <div class="col">
                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Unit Price (HKD)</label>
                        <input v-model="inventory.price" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="location in warehouse">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Donated by</label>
                        <input v-model="inventory.name" type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="name">
                    </div>

                    <div class="col">
                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Location</label>
                        <input v-model="inventory.location" type="text" class="form-control"
                            id="exampleFormControlInput1" placeholder="location in warehouse">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label">Address 2</label>
                        <textarea v-model="inventory.address" class="form-control" id="exampleFormControlTextarea1"
