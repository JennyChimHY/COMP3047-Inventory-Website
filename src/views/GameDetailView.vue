        ...
        <div class="container">
            <form>
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Quantity</label>
                            <input v-model="inventory.quantity" type="number" class="form-control"
